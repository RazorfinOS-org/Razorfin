...
<p>
  ...
  <a href="https://github.com/RazorfinOS-org/Razorfin/releases/latest"><picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/github/release/RazorfinOS-org/Razorfin.svg?size=xs&theme=dark">
    <img alt="release" src="https://shieldcn.dev/github/release/RazorfinOS-org/Razorfin.svg?size=xs">
  </picture></a>
  <a href="LICENSE"><picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://shieldcn.dev/github/license/RazorfinOS-org/Razorfin.svg?size=xs&theme=dark">
    <img alt="license" src="https://shieldcn.dev/github/license/RazorfinOS-org/Razorfin.svg?size=xs">
  </picture></a>
  <a href="https://bazzite.gg/"><img alt="built on Bazzite" src="https://shieldcn.dev/badge/built_on-Bazzite-orange.svg?logo=fedora&size=xs"></a>
  <a href="https://system76.com/cosmic"><img alt="desktop COSMIC" src="https://shieldcn.dev/badge/desktop-COSMIC-blue.svg?logo=system76&size=xs"></a>
  <a href="https://github.com/orgs/RazorfinOS-org/packages?repo_name=Razorfin"><img alt="images on GHCR" src="https://shieldcn.dev/badge/images-GHCR-blue.svg?logo=github&size=xs"></a>
  <a href="#image-verification"><img alt="signed with cosign" src="https://shieldcn.dev/badge/signed-cosign-green.svg?logo=ri:GoShieldLock&size=xs"></a>
</p>
